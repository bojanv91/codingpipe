...
description: "Implementing resilient HTTP requests in .NET Core applications using Flurl and Polly libraries, with examples of retry policies and error handling."
slug: retry-failed-http-requests-in-dotnet
tags:
  - dotnet
  - http
  - resilience
